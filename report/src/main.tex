...
\def\aclpaperid{congruence} %  Enter the acl Paper ID here
...
\title{Analyzing the congruence of different language models}

\author{Andrés Cabero Busto \\
  Institut für Maschinelle Sprachverarbeitung (IMS) / Stuttgart \\
  \texttt{st176559@stud.uni-stuttgart.de}
}
